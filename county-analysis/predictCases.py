...
print('The predicted number of COVID-19 cases in Maharashtra, India for the next 3 days are:')
print(f(5), f(6), f(7))
z = ((f(7)-f(4))/f(4))*100
print('The predicted percent increase in COVID-19 cases in Maharashtra, India over the next 3 days is:')
print(z)
